                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group row">
                                <input class="btn btn-outline-light my-2 my-sm-0" id="button" type="submit" value="Register" name="submit">
                            </div>
                            <p id="register_link" class="col-md-12">Everything is required.
                            </p>
                        </div>
                    </div>
                </form>
